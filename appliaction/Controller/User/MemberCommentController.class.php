 ...
 *      tel:400-600-2042
 */
class MemberCommentController extends AdminBaseController {
    ...
    public function lists() {
    	if(IS_POST){
    		...
    		include $this->admin_tpl('member_comment_list');
    	}
    }
    ...
    public function reply() {
    	...
    	if (IS_POST) {
    		...
    		showmessage('评论回复成功', U('MemberComment/lists'), 1);
    	} else {
    		include $this->admin_tpl('member_comment_reply');
    	}
    }
    ...
    public function delete() {
    	...
    	showmessage('评论数据删除成功', U('MemberComment/lists'), 1);
    }
}